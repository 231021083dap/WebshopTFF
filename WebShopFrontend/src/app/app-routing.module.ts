...
[
  ...
  { path : 'mysite', component: MySiteComponent, canActivate: [AuthGuard], data: { roles: [Role.Customer] } },
  { path : 'mycart', component: MyCartComponent, canActivate: [AuthGuard], data: { roles: [Role.Customer] } },
